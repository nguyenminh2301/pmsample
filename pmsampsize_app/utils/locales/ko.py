KO = {
        ...
        "title_a2_1": "A2.1: 로지스틱 검정력 (Hsieh)",
        "title_a2_2": "A2.2: Cox 검정력 (Schoenfeld)",
        "title_a3_1": "A3.1: Riley 외 (분석적)",
        "title_a3_2": "A3.2: 개발 시뮬레이션",
        "title_a3_3": "A3.3: 베이지안 보증",
        "title_a4_1": "A4.1: AUC 정밀도 (Hanley-McNeil)",
        "title_a4_2": "A4.2: 외부 검증 (맞춤형)",
        "title_a4_3": "A4.3: 외부 검증 (시뮬레이션)",
        "title_b1": "B1: Green의 법칙",
        "title_b2": "B2: Riley 외 (연속형)",
        "title_c1": "C1: Riley 외 (생존분석)",

        "mode_riley": "방법 A3.1: Riley 외 (분석적)",
        "mode_bayes": "방법 A3.3: 베이지안 보증 (시뮬레이션)",
        "mode_single": "단일 시나리오",
        "mode_batch": "민감도 분석 (범위)",
        "method1_tab": "방법 A3.1 (Riley)",
        "method2_tab": "방법 A3.3 (Bayesian)",
        "nav_title": "탐색",
        ...
        "formula_heading": "수학적 프레임워크 (방법 A3.1)",
        "formula_intro": "방법 A3.1은 Riley 등이 제공한 폐쇄형 솔루션을 사용하고, 방법 A3.3은 베이지안 MCMC 시뮬레이션을 사용합니다.",
        ...
        "mode_dev_sim": "방법 A3.2: 개발 시뮬레이션 (빈도주의)",
        "method6_tab": "방법 A3.2 (시뮬레이션)",
        ...
        "quick_mode_epv": "A1.1: EPV / EPP 규칙 (경험적)",
        "quick_mode_risk": "A1.2: 기본 위험 정밀도 (CI 너비)",
        ...
        "title_b3": "A2.1: 로지스틱 검정력 (Hsieh)",
        "title_b4": "A2.2: Cox 검정력 (Schoenfeld)",
...
**A3.1 — Riley 등 (분석적; pmsampsize 유사)**
...
**A3.2 — 개발 시뮬레이션 (빈도주의; samplesizedev/사용자 정의 DGM)**
...
**A4.1 — AUC 정밀도 (Hanley–McNeil / presize)**
...
**A4.2 — 외부 검증 (맞춤형; pmvalsampsize / sampsizeval)**
...
A3.1은 **이분형 결과**(로지스틱 회귀)를 가진 **다변량 임상 예측 모델 개발**을 위한 **Riley 등의 분석적 최소 표본 크기 기준**을 구현합니다. 목표는 개발 데이터 세트가 충분히 커서 다음을 보장하는 것입니다:
...
""",
        "c6_content_md": r"""
## A3.2: 개발 시뮬레이션 (빈도주의; 사용자 정의 DGM)


A3.2는 **예측 모델 개발**(이분형 결과)을 위한 **시뮬레이션 기반 표본 크기 계획** 접근 방식이며, **samplesizedev** 및 더 광범위한 시뮬레이션 기반 설계 원칙의 철학에서 영감을 받았습니다.
